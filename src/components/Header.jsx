  ...
  return (
    <header className="w-full z-10 grid grid-cols-3 gap-2 fixed py-3 px-8 xl:px-4 top-0 left-0 justify-between ">
      ...
      <div className="w-full flex place-content-center">
          <a href="/" className="sm: hidden xl:inline uppercase backdrop-blur-md text-sm font-roman py-1 px-8 ring-1 ring-current rounded-3xl border-current">Hire me</a>
      </div>

      <div className="sm: hidden xl:inline w-full text-right uppercase">
